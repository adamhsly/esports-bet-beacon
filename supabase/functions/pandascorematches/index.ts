...
serve(async () => {
  ...
  console.log(`📊 Total matches: ${total} → Total pages: ${totalPages}`)
  ...
  if (!Array.isArray(matches) || matches.length === 0) {
    console.log('✅ No matches to process on this page.')
  ...
  return new Response(JSON.stringify({ status: 'done', totalFetched, page }), {
