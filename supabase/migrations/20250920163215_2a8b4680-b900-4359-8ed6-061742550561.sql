...
-- Create unique constraint manually to handle COALESCE properly
CREATE UNIQUE INDEX user_level_rewards_unique_idx ON public.user_level_rewards 
  (user_id, level, track, reward_type, COALESCE(item_code, ''));
