-- CRITICAL SECURITY FIX: Phase 1 - Enable RLS on all unprotected tables
...
ALTER TABLE public.pandascore_view_teams ENABLE ROW LEVEL SECURITY;
...
CREATE POLICY "PandaScore team view is publicly readable" ON public.pandascore_view_teams
  FOR SELECT USING (true);
