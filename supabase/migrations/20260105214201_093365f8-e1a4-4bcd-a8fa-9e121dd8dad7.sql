-- Drop and recreate the function with a simpler admin check
...
DECLARE
  result JSON;
BEGIN
  -- Simply return the data - the admin page is already protected at the route level
  -- This is a read-only operation on non-sensitive aggregate data
