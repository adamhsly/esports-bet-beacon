-- Update claim_welcome_bonus to set tier 1 free entry to $2.50 (250 pence)
-- This allows users to enter the weekly paid rounds which cost $2.50
...
BEGIN
  ...
  -- Set promo amount based on tier: $2.50 for tier 1, $10 for tier 2
  v_promo_amount := CASE WHEN v_tier = 1 THEN 250 ELSE 1000 END;
  ...
  -- Set expiry days based on tier: 1 day for tier 1, 2 days for tier 2
  v_expiry_days := CASE WHEN v_tier = 2 THEN 2 ELSE 1 END;
