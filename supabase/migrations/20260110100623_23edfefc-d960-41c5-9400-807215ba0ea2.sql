-- Drop and recreate the get_welcome_offer_status function with correct tier 1 reward (250 pence = 1 free entry)
...
DECLARE
  ...
  v_tier1_reward_pence INTEGER := 250; -- £2.50 (exactly one paid round entry)
