        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
          ...
          <TabsContent value="signup" className="space-y-4">
            <form onSubmit={handleSignUp} className="space-y-4">
              ...
              {/* Date of Birth */}
              <div className="space-y-2">
                <Label className="text-gray-300 flex items-center justify-center">
                  <User className="inline w-4 h-4 mr-2" />
                  Date of Birth
                </Label>
                <div className="grid grid-cols-3 gap-2">
                  <Select value={dobDay} onValueChange={setDobDay}>
                    <SelectTrigger className="bg-theme-gray-dark border-theme-gray-light text-white">
                      <SelectValue placeholder="Day" />
                    </SelectTrigger>
                    <SelectContent className="bg-theme-gray-dark border-theme-gray-light max-h-60">
              ...
              <div className="flex items-start gap-2">
                ...
                />
                <Label htmlFor="marketing-modal" className="text-xs text-gray-400 cursor-pointer leading-tight">
