...
export const PandaScoreFinishedMatchHeader: React.FC<PandaScoreFinishedMatchHeaderProps> = ({
  match
}) => {
      ...
      <div className="flex flex-col gap-2 px-3 py-3">
        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center gap-2 flex-1">
            ...
            {tier && tier !== 'unranked' && <Badge variant="outline" className="bg-purple-500/20 text-purple-400 border-purple-400/30 text-xs">
        ...
        {results && results.length > 0 && <div className="flex justify-center items-center py-3">
