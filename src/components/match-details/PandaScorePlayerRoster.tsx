...
export const PandaScorePlayerRoster: React.FC<PandaScorePlayerRosterProps> = ({
  ...
  const renderDataStatus = (teamName: string, playerCount: number) => <div className="flex items-center gap-2 text-sm">
      {playerCount > 0 ? <>
  ...
  return <Card className="bg-theme-gray-dark border border-theme-gray-medium overflow-hidden mb-8">
      ...
      <div className="p-4">
        ...
        {!hasAnyData && <div className="text-center py-8 text-gray-400 bg-theme-gray-medium/10 rounded-lg">
