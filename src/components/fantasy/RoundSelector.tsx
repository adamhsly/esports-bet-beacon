...
// Round Details Modal Component
const RoundDetailsModal: React.FC<{
  round: Round;
  open: boolean;
  onOpenChange: (open: boolean) => void;
}> = ({ round, open, onOpenChange }) => {
  const prizeType = round.prize_type || "credits";
  const prizeSymbol = prizeType === "vouchers" ? "$" : "";
  const prizeSuffix = prizeType === "credits" ? " Credits" : "";
