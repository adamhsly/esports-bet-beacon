          ...
          <button
            ...
            className={cn(
              ...
              selectedGameType === game.value
                ? "border-theme-purple bg-theme-purple/20 shadow-lg shadow-theme-purple/30"
                : "border-theme-gray-medium bg-theme-gray-dark hover:border-theme-purple/50 hover:bg-theme-purple/10",
