...
const ESPORT_COLORS: Record<string, string> = {
  ...
  'dota2': 'bg-red-600/20 text-red-400 border-red-600/50',
  'dota-2': 'bg-red-600/20 text-red-400 border-red-600/50',
  'valorant': 'bg-pink-500/15 text-pink-300 border-pink-500/40',
...
const ESPORT_TEXT_COLORS: Record<string, string> = {
  'counter-strike': 'text-orange-300',
  'cs-go': 'text-orange-300',
  'cs2': 'text-orange-300',
  'lol': 'text-sky-300',
  'league-of-legends': 'text-sky-300',
  'lol-wild-rift': 'text-cyan-300',
  'dota2': 'text-red-400',
  'dota-2': 'text-red-400',
  'valorant': 'text-pink-300',
  'rainbow-6-siege': 'text-yellow-300',
  'rocket-league': 'text-blue-300',
  'starcraft-2': 'text-indigo-300',
  'overwatch': 'text-amber-300',
  'king-of-glory': 'text-fuchsia-300',
  'call-of-duty': 'text-emerald-300',
  'pubg': 'text-lime-300',
  'mobile-legends': 'text-violet-300',
  'ea-sports-fc': 'text-green-300',
};

const getEsportTextClass = (val?: string | null) =>
  (val && ESPORT_TEXT_COLORS[val]) || 'text-theme-purple';

export const PickemsSlateCard: React.FC<Props> = ({ slate, matchCount, hasPicks }) => {
        ...
        <CardContent className="p-4 space-y-2">
          <div className="flex items-start justify-between gap-2">
            <div className="min-w-0 flex-1 space-y-1">
              <div className="flex items-center gap-2 flex-wrap">
                ...
                {hasPicks && (
                  <span
                    ...
                    title="You've made picks for this slate"
                  >
              ...
              {gameLabel && (
                <p className={`text-xs font-medium flex items-center gap-1 ${getEsportTextClass(slate.esport_type)}`}>
