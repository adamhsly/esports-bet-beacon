    ...
    queryFn: async () => {
      ...
      console.log('✅ PandaScore match details retrieved from database:', {
        ...
        team1: {
          ...
          playerCount: match.teams[0]?.players?.length || 0
        },
        team2: {
          name: match.teams[1]?.name,
          playerCount: match.teams[1]?.players?.length || 0
        }
      });
      return match;
    },
  ...
  return <div className="min-h-screen flex flex-col bg-theme-gray-dark theme-alt-card">
      ...
      <div className="flex-grow max-w-5xl mx-auto w-full px-2 md:px-8 py-2 md:py-8">
        <div className="space-y-4 md:space-y-8">
          ...
          {hasStreams && headerType !== 'finished' && <Card className="bg-card border border-border">
              <div className="p-4">
          ...
          <Card className="bg-card border border-border">
            <div className="p-4">
              ...
              <PandaScorePreMatchStats teams={matchDetails.teams} tournament={matchDetails.tournament} esportType={matchDetails.esport_type} matchId={matchDetails.match_id} />
            </div>
          </Card>

          {/* Community Predictions for upcoming matches */}
          {headerType === 'upcoming' && <Card className="bg-gradient-to-b from-[#2B2F3A] to-[#1B1F28] border border-white/5 rounded-xl shadow-[0_4px_15px_rgba(0,0,0,0.4),inset_0_0_8px_rgba(255,255,255,0.05),0_0_12px_rgba(73,168,255,0.3)] transition-all duration-[250ms] ease-in-out hover:scale-[1.02] hover:shadow-[0_4px_15px_rgba(0,0,0,0.4),inset_0_0_8px_rgba(255,255,255,0.05),0_0_15px_rgba(73,168,255,0.4)]">
              <div className="p-4">
                <h3 className="text-lg font-bold text-white mb-4">Community Predictions</h3>
                <MatchVotingWidget matchId={matchDetails.id} teams={[{
          ...
          <Card className="bg-card border border-border">
            <div className="p-4">
              ...
              <PandaScorePlayerRoster teams={matchDetails.teams} esportType={matchDetails.esport_type} />
            </div>
          </Card>
